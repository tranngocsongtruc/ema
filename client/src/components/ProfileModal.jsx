                            ...
                            <label htmlFor="profile_picture" className="block text-sm font-medium text-gray-700 mb-1">
                                ...
                                <div className="group/profile relative">
                                    <img
                                        ...
                                        alt="your current profile picture shows initially, you could click on it to pick another picture from your machine"
                            ...
                            <label htmlFor="cover_photo" className="block text-sm font-medium text-gray-700 mb-1">
                                ...
                                <div className="group/cover relative">
                                    <img
                                        ...
                                        alt="the current cover photo of your profile shows initially, you could click on it to pick another photo from your machine"
