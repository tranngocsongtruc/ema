        ...
        <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
            <div className="max-w-6xl mx-auto p-6">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-slate-600">Share thoughts with community</p>
                </div>
                ...
                <div className="max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                        <img src={user.profile_picture} alt="your profile picture" className="w-12 h-12 rounded-full shadow"/>
                        <div>
                        ...
                        images.length > 0 && <div className="flex flex-wrap gap-2 mt-4">
                            {images.map((image, i)=>(
                                <div key={i} className="relative group">
                                    <img src={URL.createObjectURL(image)} className="h-20 rounded-md" alt="the image and/or images of your post" />
                                    <div 
                    ...
                    {/* Bottom Bar */}
                    <div className="flex tems-center justify-between pt-3 border-t border-gray-300">
